// ============================================================
// Omnichord OM-84 Strumplate Top Plate
// ============================================================
...
scurve_t1          = 0.1;  // 0-1, position of the LEFT control point along the chord
scurve_ctrl1_offset = -0.5;    // mm, LEFT lobe control offset (+ = bulges out, - = dips in)
scurve_t2          = 0.5;  // 0-1, position of the RIGHT control point along the chord
scurve_ctrl2_offset = 5;  // mm, RIGHT lobe control offset (+ = bulges out, - = dips in)
...
valley_length     = contact_pitch * (contact_count - 1) + 12; // total span of the row, ~139.7mm
valley_margin_top    = 5;  // gap kept between the top-left corner and the start of the valley
...
pad_to_valley_center_dist = 26; // distance between pad-cluster center and valley center, mm
